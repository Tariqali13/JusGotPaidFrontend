        ...
        <div className="container-fluid">
          ...
          <div className="mx-auto w-75 mt-5">
            <div className="card d-sm-flex align-items-center">
              {!_get(userData, 'image_id.file_url', '') && <img className="card-img-top rounded w-25" src="/img/avatar.png" alt="Card image cap"/>}
              {_get(userData, 'image_id.file_url', '') && <img className="card-img-top rounded w-25" src={_get(userData, 'image_id.file_url', '') } alt="Card image cap"/>}
                <div className="card-body">
                  <table className="table  table-borderless">
                    <tbody>
                    <tr>
                      <td>Name</td>
                      <td>{_get(userData, 'first_name')} {_get(userData, 'last_name')}</td>
                    </tr>
                    <tr>
                      <td>Email</td>
